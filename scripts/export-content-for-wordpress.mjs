 ...
 *
 * Usage: node scripts/export-content-for-wordpress.mjs
 */
...
// Import page data
import { homePage } from '../src/lib/data/pages/home.ts';
import { aboutPage } from '../src/lib/data/pages/about.ts';
import { accommodationsPage } from '../src/lib/data/pages/accommodations.ts';
import { activitiesPage } from '../src/lib/data/pages/activities.ts';
import { contactPage } from '../src/lib/data/pages/contact.ts';
import { diningPage } from '../src/lib/data/pages/dining.ts';
import { galleryPage } from '../src/lib/data/pages/gallery.ts';
import { reservePage } from '../src/lib/data/pages/reserve.ts';
import { offersPage } from '../src/lib/data/pages/offers.ts';
import { faqPage } from '../src/lib/data/pages/faq.ts';
import { mainLodgePage } from '../src/lib/data/pages/main-lodge.ts';

// Import collections
import { rooms } from '../src/lib/data/rooms.ts';
import { activities } from '../src/lib/data/activities.ts';
import { faqCategories } from '../src/lib/data/faq.ts';
...
\`\`\`bash
node scripts/export-content-for-wordpress.mjs
\`\`\`
